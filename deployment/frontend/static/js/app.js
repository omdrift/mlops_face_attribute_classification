...
function createImageCard(image) {
   ...
   const labels = {
       barbe: ATTRIBUTE_LABELS.barbe[image.attributes.barbe],
       moustache: ATTRIBUTE_LABELS.moustache[image.attributes.moustache],
       lunettes: ATTRIBUTE_LABELS.lunettes[image.attributes.lunettes],
       taille: ATTRIBUTE_LABELS.taille_cheveux[image.attributes.taille_cheveux],
       couleur: ATTRIBUTE_LABELS.couleur_cheveux[image.attributes.couleur_cheveux]
   };
